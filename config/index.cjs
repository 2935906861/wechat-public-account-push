...
const USER_CONFIG = {
  ...
  USERS: [
    {
      ...
      festivals: [
        ...
        {
          type: '*生日', name: '美丽可爱亲亲老婆', year: '2001', date: '05-12',
        },
        {
          type: '节日', name: '被搭讪纪念日', year: '2020', date: '03-17',
        },
      ...
      customizedDateList: [
        // 在一起的日子
        { keyword: 'love_day', date: '2020-03-17' },
        // 结婚纪念日
  ...
  CALLBACK_TEMPLATE_ID: '_xy3Cj9GF4j30tlk35eqwfwh2opy62cLwV7KheykS7I',
  ...
  FESTIVALS: [
    // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
    {
      type: '*生日', name: '美丽可爱亲亲老婆', year: '2001', date: '05-12', isShowAge: true,
    },
    {
      type: '节日', name: '被搭讪纪念日', year: '2020', date: '03-17',
    },
